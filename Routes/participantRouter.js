...
participantRoutes.put('/addParticipantToActivity/:id', checkToken, checkInput, async (req, res) => {
    try {
        const { id } = req.params;
...
participantRoutes.put('/removeParticipantFromActivity/:id', checkToken, checkInput, async (req, res) => {
    try {
        const { id } = req.params;
...
participantRoutes.get('/getActivityParticipants/:id', async (req, res) => {
...
participantRoutes.get('/activities-by-participants/:userid', async (req, res) => {
